      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              <h3 className="mb-4 text-2xl font-bold md:text-3xl">
                Stay ahead with ALCAS Digital
              </h3>
              <p className="text-foreground/70 mb-6">
                Join thousands of professionals who trust ALCAS Digital for
        ...
        <div className="mb-16 grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="col-span-2 lg:col-span-1">
            <div className="mb-6 flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">ALCAS Digital</span>
            </div>
        ...
        <div className="border-foreground/10 flex flex-col items-center justify-between border-t pt-8 md:flex-row">
          <p className="text-foreground/60 mb-4 text-sm md:mb-0">
            © {new Date().getFullYear()} ALCAS Digital Marketing Agency. All rights reserved.
          </p>
