...
new_section = f"""        <section class="pricing-body-section">
            <div class="container">
                {html_nav}
...
def process_file(filepath):
    try:
        ...
        start_marker = '<section class="pricing-body-section">'
        end_marker = '<section class="footer-cta">'
        ...
        if start_idx != -1 and end_idx != -1:
            ...
            # Additional cleanup for any lingering encoding issues
